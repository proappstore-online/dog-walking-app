...
// Inline paw SVG icon — no extra dependency
  ...
  return (
    ...
    >
      ...
      {photoUrl ? (
        ...
        <div className="aspect-video w-full bg-amber-100 dark:bg-amber-900 flex items-center justify-center">
          <PawIcon />
        </div>
      )}
